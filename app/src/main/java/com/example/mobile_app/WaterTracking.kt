...
import com.example.mobile_app.databinding.ActivityWaterTrackingBinding
...
class WaterTracking : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navController = findNavController(R.id.nav_host_fragment_activity_water_tracking)
